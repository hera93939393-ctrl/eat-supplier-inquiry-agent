...
### 최종 결과 — F1 포함 (`experiments/gpt4o_final_v2.json`, `.log`)

| 지표 | Ollama 베이스라인 | GPT-4o (role분리 버그) | GPT-4o (문서 보강 후, 최종) |
|---|---|---|---|
| 의도 분류 정확도 (①) | 77% | 83% | **87% (26/30)** |
| 의도 분류 macro F1 | — | — | **0.868** |
| 1턴 답변 통과율 (②) | 73% | 50%(버그) → 80%(수정 후) | **93% (28/30)** |
